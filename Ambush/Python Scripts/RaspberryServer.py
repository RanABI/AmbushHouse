...
def getDoorReplyString(data,ans,action):
    ...
    if(action == Action.Get.value):
        ans = str("AR:GET_REPLY:DR:" + str(did) + ":" + str(ans) + ":" + str(data[Data.direction.value]) + ":" +str(data[Data.physicalID.value]) + ":")
        
        return ans
    elif(action == Action.Set.value):
        return "AR:SET_REPLY:DR:" + str(did) + ":" + str(ans) + ":" + str(data[Data.direction.value]) + ":" + str(data[Data.physicalID.value]) + ":"
...
def getTargetReplyString(data,ans,action):
    ...
    if(action == Action.Get.value):
        return "AR:GET_REPLY:TR:" + str(tid) + ":" + str(ans) + ":" + str(data[Data.direction.value])+ ":" + str(data[Data.physicalID.value])
    elif(action == Action.Set.value):
        return "AR:SET_REPLY:TR:" + str(tid) + ":" + str(ans) + ":" + str(data[Data.direction.value]) + ":" + str(data[Data.physicalID.value])
...
def ProcessRequest(data):
    ...
    if(str(data[Data.action.value]) == str(Action.Get.value)):
	    ...
	    print("Return full CPX door status content")
            #Return handlrComponentGet full array############################################
